...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/react-native-apple-authentication/react_native_apple_authentication.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/react-native-gps-state/react_native_gps_state.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/react-native-simple-toast/react_native_simple_toast.framework"
fi
