                            ...
                            <Form>
                                ...
                                <View style={styles.sectionRow}>
                                    <View style={styles.threeRow}>
                                        <Input ref={fname => { this.fname = fname }} inputContainerStyle={fname && styles.inputError} rightIcon={fname && this.common.getIcon()} errorMessage={fname && "First Name required"} value={this.state.fname} onChangeText={(text) => this.setState({ 'fname': text })} placeholder="First Name" inputStyle={[styles.font15]} />
                                    </View>
                                    <View style={styles.threeRow}>
                                        <Input ref={lname => { this.lname = lname }} inputContainerStyle={lname && styles.inputError} rightIcon={lname && this.common.getIcon()} errorMessage={lname && "Last Name required"} value={this.state.lname} onChangeText={(text) => this.setState({ 'lname': text })} placeholder="Last Name" inputStyle={[styles.font15]} />
                                    </View>
                                </View>
                                ...
                                <Input ref={phone => { this.phone = phone }} keyboardType="numeric" inputContainerStyle={phone && styles.inputError} rightIcon={phone && this.common.getIcon()} errorMessage={phone && "Phone No required"} value={this.state.phone} onChangeText={(text) => this.setState({ 'phone': text })} placeholder="Phone No" inputStyle={[styles.font15]} />
                                <Input ref={Age => { this.Age = Age }} inputContainerStyle={Age && styles.inputError} rightIcon={Age && this.common.getIcon()} errorMessage={Age && "Agency name required"} value={this.state.Age} onChangeText={(text) => this.setState({ 'Age': text })} placeholder="Age" inputStyle={[styles.font15]} />
                                ...
                                <Input ref={Status => { this.Status = Status }} inputContainerStyle={Age && styles.inputError} rightIcon={Status && this.common.getIcon()} errorMessage={Age && "Agency name required"} value={this.state.Status} onChangeText={(text) => this.setState({ 'Status': text })} placeholder="Enter Status" inputStyle={[styles.font15]} />
                                <View style={{ marginTop: 10, marginLeft: 10, color: 'gray' }}>
                                    <Text style={{ fontSize: 14, color: 'gray' }}>Enter Drinks/Appetizer</Text>
                                </View>
                                <View style={styles.sectionRow}>
                                    <View style={styles.threeRow}>
                                        <Input inputContainerStyle={fname && styles.inputError} rightIcon={fname && this.common.getIcon()} value={this.state.fname} onChangeText={(text) => this.setState({ 'fname': text })} placeholder="1" inputStyle={[styles.font15]} />
                                    </View>
                                    <View style={styles.threeRow}>
                                        <Input inputContainerStyle={lname && styles.inputError} rightIcon={lname && this.common.getIcon()} value={this.state.lname} onChangeText={(text) => this.setState({ 'lname': text })} placeholder="2" inputStyle={[styles.font15]} />
                                    </View>
                                </View>
                            </Form>
                        </View>
